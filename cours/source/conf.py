...
project = u'HTML5 et CSS3 pour les jeunes'
...
html_title = "HTML5 et CSS3 pour les jeunes"  ## overridden to remove "documentation"
...
latex_documents = [
  ('index', 'intro.tex', u'Introduction au Web',
   u'Amélie Cordier', 'manual'),
]
...
texinfo_documents = [
  ('index', 'intro', u'Introduction',
   u'Amélie Cordier', 'intro', 'One line description of project.',
   'Miscellaneous'),
]
